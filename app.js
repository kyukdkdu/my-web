...
/* ================= 三、种子创作者与作品 ================= */
/* 图片源：本地真实图片 images/work-XX.jpg
   —— 随项目一起部署到服务器，全球可访问，零外部请求、不依赖任何第三方图床 */
const LOCAL_IMGS = {
  l: ['images/work-01.jpg', 'images/work-05.jpg', 'images/work-08.jpg', 'images/work-10.jpg'],
  p: ['images/work-02.jpg', 'images/work-04.jpg', 'images/work-06.jpg', 'images/work-09.jpg'],
  s: ['images/work-03.jpg', 'images/work-07.jpg']
};
const ALL_IMGS = [...LOCAL_IMGS.l, ...LOCAL_IMGS.p, ...LOCAL_IMGS.s];
const U = (seed, orient) => {
  let h = 0;
  for (let i = 0; i < seed.length; i++) h = (h * 31 + seed.charCodeAt(i)) >>> 0;
  const pool = (LOCAL_IMGS[orient] && LOCAL_IMGS[orient].length) ? LOCAL_IMGS[orient] : ALL_IMGS;
...
const SEED_ITEMS = [
  { id: 's1',  author: 'kenji', type: 'photo', orient: 'l', price: 0, tags: ['nature', 'minimal'], likes: 328,
    title: { zh: '晨雾山峦', en: 'Misty Mountain Layers', ja: '霧の山並み', ko: '안개 낀 산령' },
    img: 'images/work-01.jpg' },
  { id: 's2',  author: 'luna', type: 'photo', orient: 'p', price: 12, tags: ['nature'], likes: 512,
    title: { zh: '云雾青山', en: 'Cloud-wrapped Green Mountain', ja: '雲に包まれた青山', ko: '구름에 싸인 청산' },
    img: 'images/work-02.jpg' },
  { id: 's3',  author: 'mia', type: 'photo', orient: 's', price: 0, tags: ['portrait', 'minimal'], likes: 276,
    title: { zh: '白车少女', en: 'Girl on White Bike', ja: '白い自転車の少女', ko: '흰 자전거 소녀' },
    img: 'images/work-03.jpg' },
  { id: 's4',  author: 'ahao', type: 'photo', orient: 'p', price: 8, tags: ['nature', 'minimal'], likes: 189,
    title: { zh: '蓝岸长天', en: 'Blue Shoreline', ja: '青い海岸線', ko: '푸른 해안선' },
    img: 'images/work-04.jpg' },
  { id: 's5',  author: 'luna', type: 'photo', orient: 'l', price: 25, tags: ['architecture', 'minimal'], likes: 643,
    title: { zh: '静默圣堂', en: 'Silent Cathedral', ja: '静寂の聖堂', ko: '고요한 성당' },
    img: 'images/work-05.jpg' },
  { id: 's6',  author: 'kenji', type: 'photo', orient: 'p', price: 0, tags: ['nature'], likes: 204,
    title: { zh: '金色花田', en: 'Golden Flower Field', ja: '金色の花畑', ko: '금빛 꽃밭' },
    img: 'images/work-06.jpg' },
  { id: 's7',  author: 'mia', type: 'photo', orient: 's', price: 10, tags: ['city', 'minimal'], likes: 351,
    title: { zh: '拱桥剪影', en: 'Silhouette on Arch Bridge', ja: 'アーチ橋のシルエット', ko: '아치교의 실루엣' },
    img: 'images/work-07.jpg' },
  { id: 's8',  author: 'kenji', type: 'photo', orient: 'l', price: 6, tags: ['nature'], likes: 427,
    title: { zh: '湖畔秋芦', en: 'Lakeside Reeds', ja: '湖畔の葦', ko: '호숫가의 갈대' },
    img: 'images/work-08.jpg' },
  { id: 's9',  author: 'luna', type: 'photo', orient: 'p', price: 0, tags: ['minimal'], likes: 298,
    title: { zh: '木桌光影', en: 'Wooden Desk Light', ja: '木の机の光と影', ko: '나무 책상의 빛과 그림' },
    img: 'images/work-09.jpg' },
  { id: 's10', author: 'mia', type: 'photo', orient: 'l', price: 5, tags: ['nature', 'minimal'], likes: 167,
    title: { zh: '青天飞鸟', en: 'Birds in Azure Sky', ja: '青空の飛鳥', ko: '푸른 하늘의 새들' },
    img: 'images/work-10.jpg' },
  { id: 's11', author: 'ahao', type: 'photo', orient: 'l', price: 9, tags: ['nature', 'minimal'], likes: 389,
    title: { zh: '群峰叠翠', en: 'Verdant Peaks', ja: '緑の峰々', ko: '푸른 산봉우리' },
    img: 'images/work-01.jpg' },
  { id: 's12', author: 'mia', type: 'photo', orient: 'p', price: 7, tags: ['nature'], likes: 455,
    title: { zh: '青山云影', en: 'Green Mountain in Clouds', ja: '青山の雲の影', ko: '청산의 구름 그림자' },
    img: 'images/work-02.jpg' },
  { id: 's13', author: 'ahao', type: 'photo', orient: 's', price: 39, tags: ['minimal', 'retro'], likes: 96,
    title: { zh: '桥上行人', en: 'Crossing the Bridge', ja: '橋を渡る人', ko: '다리를 건너는 사람' },
    img: 'images/work-07.jpg' },
  { id: 's14', author: 'kenji', type: 'photo', orient: 'p', price: 11, tags: ['nature'], likes: 233,
    title: { zh: '海天一色', en: 'Sea Meets Sky', ja: '海と空の境界', ko: '바다와 하늘' },
    img: 'images/work-04.jpg' },
  { id: 's15', author: 'luna', type: 'photo', orient: 'l', price: 0, tags: ['architecture', 'minimal'], likes: 571,
    title: { zh: '独坐光阴', en: 'Sitting Alone in Light', ja: '一人、光の中', ko: '홀로 빛 속에' },
    img: 'images/work-05.jpg' },
  { id: 's16', author: 'mia', type: 'photo', orient: 'p', price: 0, tags: ['nature'], likes: 188,
    title: { zh: '田野孤树', en: 'Lone Tree in Field', ja: '畑の一本木', ko: '들판의 외나무' },
    img: 'images/work-06.jpg' },
  { id: 's17', author: 'ahao', type: 'photo', orient: 'p', price: 13, tags: ['nature'], likes: 264,
    title: { zh: '山岚入云', en: 'Mountain Mist Rising', ja: '山の霞', ko: '산의 아지랑이' },
    img: 'images/work-02.jpg' },
  { id: 's18', author: 'kenji', type: 'photo', orient: 'l', price: 10, tags: ['nature'], likes: 342,
    title: { zh: '远山静水', en: 'Distant Mountain Still Water', ja: '遠山と静水', ko: '저 멀리 산과 잔잔한 물' },
    img: 'images/work-08.jpg' },
  { id: 's19', author: 'mia', type: 'photo', orient: 'p', price: 4, tags: ['minimal'], likes: 157,
    title: { zh: '指尖时光', en: 'Moment in Hand', ja: '手の中の時間', ko: '손 안의 시간' },
    img: 'images/work-09.jpg' },
  { id: 's20', author: 'luna', type: 'photo', orient: 'p', price: 15, tags: ['nature'], likes: 301,
    title: { zh: '花田余晖', en: 'Flower Field Glow', ja: '花畑の残照', ko: '꽃밭의 잔광' },
    img: 'images/work-06.jpg' },
  { id: 's21', author: 'luna', type: 'photo', orient: 'l', price: 0, tags: ['nature'], likes: 419,
    title: { zh: '翼展青空', en: 'Wings in Azure', ja: '碧空の翼', ko: '벽공의 날개' },
    img: 'images/work-10.jpg' },
  { id: 's22', author: 'ahao', type: 'photo', orient: 's', price: 18, tags: ['portrait'], likes: 276,
    title: { zh: '骑行背影', en: 'Cyclist from Behind', ja: '自転車の背中', ko: '자전거를 탄 뒷모습' },
    img: 'images/work-03.jpg' },
  { id: 's23', author: 'kenji', type: 'photo', orient: 'p', price: 0, tags: ['nature'], likes: 245,
    title: { zh: '金色麦浪', en: 'Golden Wheat Waves', ja: '金色の麦波', ko: '금빛 밀파도' },
    img: 'images/work-06.jpg' },
  { id: 's24', author: 'mia', type: 'photo', orient: 'p', price: 20, tags: ['nature', 'minimal'], likes: 387,
    title: { zh: '山间薄雾', en: 'Mountain Haze', ja: '山間の薄霞', ko: '산간의 옅은 안개' },
    img: 'images/work-02.jpg' }
];
